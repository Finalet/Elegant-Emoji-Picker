...
extension ViewController: ElegantEmojiPickerDelegate {
    ...
    func emojiPicker(_ picker: ElegantEmojiPicker, loadEmojiSections withConfiguration: ElegantConfiguration, _ withLocalization: ElegantLocalization) -> [EmojiSection] {
        return [
            EmojiSection(title: "Hey pidor", icon: UIImage(systemName: "xmark"), emojis: [
                .init(emoji: "🖕🏿", description: "fuck you", category: .Activities, aliases: [], tags: [], supportsSkinTones: true, iOSVersion: "13.0"),
                .init(emoji: "🖕🏿", description: "fuck you", category: .Activities, aliases: [], tags: [], supportsSkinTones: true, iOSVersion: "13.0"),
                .init(emoji: "🖕🏿", description: "fuck you", category: .Activities, aliases: [], tags: [], supportsSkinTones: true, iOSVersion: "13.0"),
                .init(emoji: "🖕🏿", description: "fuck you", category: .Activities, aliases: [], tags: [], supportsSkinTones: true, iOSVersion: "13.0"),
                .init(emoji: "🖕🏿", description: "fuck you", category: .Activities, aliases: [], tags: [], supportsSkinTones: true, iOSVersion: "13.0"),
            ...
            EmojiSection(title: "Hey pidor", icon: UIImage(systemName: "xmark"), emojis: [
                .init(emoji: "🖕🏻", description: "fuck you but racist", category: .Activities, aliases: [], tags: [], supportsSkinTones: false, iOSVersion: "13.0"),
                .init(emoji: "🖕🏻", description: "fuck you but racist", category: .Activities, aliases: [], tags: [], supportsSkinTones: false, iOSVersion: "13.0"),
                .init(emoji: "🖕🏻", description: "fuck you but racist", category: .Activities, aliases: [], tags: [], supportsSkinTones: false, iOSVersion: "13.0"),
                .init(emoji: "🖕🏻", description: "fuck you but racist", category: .Activities, aliases: [], tags: [], supportsSkinTones: false, iOSVersion: "13.0"),
                .init(emoji: "🖕🏻", description: "fuck you but racist", category: .Activities, aliases: [], tags: [], supportsSkinTones: false, iOSVersion: "13.0"),
